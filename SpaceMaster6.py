""" Author : Dylan Scott
        ...
        Version History:    1.0
                                        ...
                                        0.2
                                        0.1
        Patch Notes : In this version I plan on adding an increased tier of difficulty. The newest difficulty gives the player 1 extra bullet, increases the points awarded for collecting awards
        to 600 and adds 8 more enemies.
...
def masterGame():
    ...
    friendSprites = pygame.sprite.OrderedUpdates(space, ship)
    bulletSprites = pygame.sprite.OrderedUpdates(bullet1, bullet2, bullet3, bullet4, bullet5)
    awardSprites = pygame.sprite.OrderedUpdates(award1)
    enemySprites = pygame.sprite.Group(alien1, alien2, alien3, alien4, alien5, alien6, alien7, alien8, alien9, alien10, alien11, alien12, alien13, alien14, alien15, alien16, alien17, alien18, alien19, alien20, alien21, alien22, alien23, alien24)
    scoreSprite = pygame.sprite.Group(scoreboard)
    ...
    while keepGoing:
        ...
        shotEnemy = pygame.sprite.spritecollide(bullet5, enemySprites, False)
        if shotEnemy:
            ship.sndEnemyk.play()
            scoreboard.score += 200
            bullet5.reset()
