""" Author : Dylan Scott
        ...
        Version History:    0.3
                                        ...
                                        0.1
        Patch Notes :
        This this version I am going to up the number of bullets the player can use to 3 on each difficulty. I have changed the introduction screen to explain the instructions for my game. I've added the game over
        screen that takes the score of the player during his last session. I didnt feel there was enough enemies to make it challenging so I added 4 more to each difficulty.
...
def instructions(score):
    ...
    "can only fire three shots at a time.",
    "Good luck!",
    "",
