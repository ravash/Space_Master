""" Author : Dylan Scott
        ...
        Version History:    0.2
                                        0.1
        Patch Notes :
        In my game I set the bullet1 to only be able to fire one at a time. In later versions of the game I plan on adding bullets depending on your difficulty.
        I have changed over all the sounds to what I want to be in the game and played and adjusted all the volumes of the sound.
        I've changed up the speeds of the aliens to give each alien type its on little bit of style and adjust game play a little bit.
...
def easyGame():
    ...
    bulletSprites = pygame.sprite.OrderedUpdates(bullet1)
