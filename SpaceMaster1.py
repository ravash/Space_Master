""" Author : Dylan Scott
        ...
        Version : 0.1
        Patch Notes :
        For this game I decided to start using MailPilot.py as my template for my game because it is a very good place to start and I wasn't a huge fan of my rushed Assignment 4.
        The sprite's used for my game I acquired from http://spriters-resource.com/ with the background being custom made by me.
        In this version I have taken out majority of the code that is attributed to the classes of MailPilot and rewrote it for classes in my game.
        So far my game has one difficulty ( which I plan on working on soon ) and the main player doesn't have the ability to shoot ( Also I plan on making the enemies have a chance of shooting, maybe increased
        chance depending on difficulty?)
        The current version the points are based 100% of collecting either award of the two awards ( I plan on maybe making it that each difficulty has different number of awards on the screen, Easy have 3
        , normal having 2 and hard having only one award the player can collect)
...
def game():
    ...
    enemySprites = pygame.sprite.Group(alien1, alien2, alien3)
